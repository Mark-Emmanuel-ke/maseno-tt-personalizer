...
**In short:**
1. Add 4 GitHub Secrets (username, repo, encrypted token)
2. GitHub Actions automatically deploys on each push
3. Admin changes auto-commit to your repo
