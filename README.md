...
**LIMITATION**: The site is hosted on github pages thus true backend can never be achieved, all configurations files are loaded in client side including the auth function
### Managing Timetables
